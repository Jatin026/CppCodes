...
// calculate the cnt of people attacking a person
// if a person getting attacked by a single person then check his orientation and correct it if needed.
void solve(){
    int n;
    cin >> n;
    string s; cin >> s;

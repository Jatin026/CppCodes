...
void solve(){
    ...
    int a = n%m , b = ((n*(1ll*(n+1)))/2)%m ;
    pr p ;
    int val = 1e9;
    for (int i = 0; i < min(m,10000000); i++)
    {
        for (int j = 0; j < min(10,m); j++)
        {
            if(val > ((sum + a*i + b*j )%m)){
                val = ((sum + a*i + b*j )%m);
                p  = {i,j};
            }
        }
    ...
    {
        for (int j = 0; j < min(10000000,m); j++)
        {
            if(val > ((sum + a*i + b*j )%m)){
                val = ((sum + a*i + b*j )%m);
                p  = {i,j};
    ...
    for (int i = 0; i < min(m,10); i++)
    {
        for (int j = max(m-10000000,0); j < min(10000000,m); j++)
        {
            if(val > ((sum + a*i + b*j )%m)){
                val = ((sum + a*i + b*j )%m);
                p  = {i,j};
    ...
    for (int i = max(m-1000,0); i < min(m,1000); i++)
    {
        for (int j = max(m-1000,0); j < min(1000,m); j++)
        {
            if(val > ((sum + a*i + b*j )%m)){
                val = ((sum + a*i + b*j )%m);
                p  = {i,j};

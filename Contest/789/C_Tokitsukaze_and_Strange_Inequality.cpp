...
void solve(){
    // one prefix function which will give count of numbers smaller than the element at the current index and having index greater than j.
    // one normal 2D array array to store indexes of number smaller than the current one.
    int n;
    cin >> n;

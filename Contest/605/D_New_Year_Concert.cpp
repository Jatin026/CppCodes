...
void solve(){
    ...
    //     else{
    //         int g = v[i];
    //         if(range.empty()) range.emplace_back(v[i],1);
    //         else{
    //             bool flag = false;
    //             int sum = 1;
    ...
    //             }
    //             else{
    //                 if(range.back().first == v[i]){
    //                     range.back().second++;
    //                 }
    //                 else range.emplace_back(v[i],1);
    //             }
    //         }
    //     }
    //     cout << ans << " ";
    ...
    for (int R = 0; R < n; R++)
    {
        int l = L , r = R , mid , flag = 0;
        while(l <= r){
            mid = ((l+r)>>1);
            int i = __lg(R - mid + 1);
            int g = gcd(st[i][mid], st[i][R - (1 << i) + 1]);
            if(R - mid + 1 < g){
                r = mid - 1;
            }
            else if(R - mid + 1 == g){

...
//simple graph each node has a   value ai
//constructed graph can be disconnected
// *make the common node a local minima or maxima;
// *if the above condition cannot be held true than a single edge has to be constructed.
// no loops can not  be cyclic

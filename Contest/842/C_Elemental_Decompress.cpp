...
void solve(){
    ...
    {   
        ...
        if(ind[i].size() == 1){
            ...
            if(ind[i].size() == 2){
                ...
                if(vaca.size() != 0 && vacb.size() != 0){
                    a[(*(vaca.begin()))] = i;
                    b[(*(vacb.begin()))] = i;
                    vaca.erase(vaca.begin());
                    vacb.erase(vacb.begin());
                }
                else{
                    cout << "NO\n";
                    return;
    ...
    //     if((ind[v[i]]).size() == 2){
    //         if(a[ind[v[i]][0]] != -1){
    //             if(a[ind[v[i]][1]] != -1) flag = 0;
    //             else {
    //                 a[ind[v[i]][1]] = v[i];
    //                 if(b[ind[v[i]][0]] != -1){
    //                     flag = 0;
    //                 }
    //                 else b[ind[v[i]][0]] = v[i];
    //             }
    //         }
    //         else {
    //             a[ind[v[i]][0]] = v[i];

...
Algo : sort by smallest value. k resides in ith index , k > i . 
...
ind1 ind2 .....indk-1 indk
i +1  i+2  ...  k      i

find for each i , what value resides there and then add (value - i) to the answer.
